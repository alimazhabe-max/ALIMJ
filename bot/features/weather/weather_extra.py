...
async def weather_forecast(city: str) -> str:
    """پیش‌بینی ۷ روزه — اول Open-Meteo حرفه‌ای، بعد wttr.in"""
    ...
    for attempt in range(2):
        try:
            ...
            logger.error(f"open-meteo forecast {attempt+1} {city}: {e}")
